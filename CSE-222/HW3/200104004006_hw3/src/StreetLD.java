...
public class StreetLD {
    ...
    private LDLinkedList<Building> lSide = new LDLinkedList<>();
    private LDLinkedList<Building> rSide = new LDLinkedList<>();
    ...
    public LDLinkedList<Building> getlSide() {
        return lSide;
    }

    public LDLinkedList<Building> getrSide() {
        return rSide;
    }
    ...
    public StreetLD() {
        lSide = new LDLinkedList();
        rSide = new LDLinkedList();
        length = 100;
    }

    public StreetLD(int lengthOfStreet) {
        lSide = new LDLinkedList();
        rSide = new LDLinkedList();
